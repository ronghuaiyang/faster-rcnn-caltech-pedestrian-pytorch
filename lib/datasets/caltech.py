...
from model.faster_rcnn.test import im_detect
import json
...
class caltech(imdb):
    def __init__(self,
                 version,
                 image_set,
                 devkit_path="caltech-pedestrian"):
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'caltech-pedestrian')
    ...
    def _load_caltech_annotation(self, index):
        ...
        if original_len > num_objs:
            print("Filter out {} non-{} boxes".format(original_len - num_objs,
                                                      self.version))
